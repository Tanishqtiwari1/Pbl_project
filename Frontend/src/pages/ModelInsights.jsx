...
export default function ModelInsights() {
  ...
  return <div className="model-insights-page">
    ...
    <div className="model-metric-grid">{metricLabels.map(([key, label]) => <div className="model-metric" key={key}><span>{label}</span><strong>{(data.metrics[key] * 100).toFixed(1)}%</strong><div className="model-meter"><i style={{ width: `${data.metrics[key] * 100}%` }} /></div></div>)}</div>
